...
<body>
	...
	<div class="wrap">
			<div class="section group">
				<div class="col span_2_of_3">
				  <div class="contact-form">
                    ...
                    ?>
                    <!-- Search-from -->
                    <form action="dokter_daftar.php?cari=$cari" method="get" class="form-inline mx-auto search-form">
        ...
        if($cari==''){
            ...
            $sql="SELECT nama_dokter FROM dokter WHERE nama_dokter like '%".$cari."%'";
        }
        ...
        if($cari==''){
            $sql="SELECT * FROM dokter ORDER BY nama_dokter ASC LIMIT $posisi, $batas";
        } else {
            $sql="SELECT * FROM dokter WHERE nama_dokter like '%".$cari."%' ORDER BY nama_dokter ASC LIMIT $posisi, $batas";
        }
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        while($hsl=$hasil->fetch_assoc()){
                                            ...
                                            echo '<td>'.$hsl['praktek_hari'].'</th>';
                                            echo '<td>'.$hsl['praktek_jam'].'</th>';
                                            echo '</tr>';
                                        }
                                        echo '</tbody></table>';
                                    ?>
