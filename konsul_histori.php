...
<body>
	...
	<div class="wrap">
			<div class="section group">
				<div class="col span_2_of_3">
				  <div class="contact-form">
                    ...
                    ?>
                    <!-- Search-from -->
                    <form action="konsul_histori.php?cari=$cari" method="get" class="form-inline mx-auto search-form">
        ...
        if($cari==''){
            $sql="SELECT id_konsul FROM konsul WHERE username='$username'";
        } else {
            $sql="SELECT id_konsul FROM konsul WHERE username='$username' AND komen_pasien like '%".$cari."%'";
        }
        ...
        if($cari==''){
            $sql="SELECT * FROM konsul WHERE username='$username' ORDER BY id_konsul ASC LIMIT $posisi, $batas";
        } else {
            $sql="SELECT * FROM konsul WHERE username='$username' AND komen_pasien like '%".$cari."%' ORDER BY id_konsul ASC LIMIT $posisi, $batas";
        }
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        while($hsl=$hasil->fetch_assoc()){
                                            ...
                                            echo "<td>";
                                            echo "<a href=\"konsul_add.php?nama_dokter=$hsl[nama_dokter]\"><img src='images/komen.png' style='width: 24px;' title='lanjutkan pertanyaan' /></a>";
                                            echo "</th>";
                                            echo '</tr>';
                                        }
                                        echo '</tbody></table>';
